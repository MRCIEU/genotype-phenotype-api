...
from app.models.schemas import BasicTraitResponse, ColocGroup, ColocPair, GetTraitsResponse, RareResult, Study, ExtendedStudyExtraction, TraitResponse, Trait, VariantType, Association, convert_duckdb_to_pydantic_model
...
async def get_trait(
    ...
    try:
        ...
        if include_coloc_pairs:
            coloc_pairs = coloc_pairs_db.get_all_coloc_pairs_for_study(trait.common_study.id)
