...
from app.rate_limiting import SHARED_ENTITY_RESOURCE_RATE_LIMIT, limiter
...
async def get_genes(
    ...
    def _run():
        try:
            ...
            region_colocs = (
                convert_duckdb_to_pydantic_model(ColocGroup, region_colocs_data) if region_colocs_data else []
            )
